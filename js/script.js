...
$(window).resize(function (event) { fworks.clear; fworks.canvas.width=event.target.innerWidth; fworks.canvas.height=event.target.innerHeight; fworks.cw=event.target.innerWidth; fworks.ch=event.target.innerHeight })
